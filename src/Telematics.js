...
const Telematics = ({ fields = [], customer = {} }) => {
  return (
    <div>
      <h1 className="text-3xl">Welcome to Telematics secure page</h1>
          ...
          <div className="w-2/3 pb-4">
            ...
            <div className="p-4">
              <div className="text-xs mb-4 mt-2">
                By checking this box, you acknowledge that you have read and agree to Telematics
